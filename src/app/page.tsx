            ...
            <div className='space-y-20'>
              ...
              <div className='text-center space-y-8'>
                ...
                <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
                  ...
                  <button className='inline-flex items-center px-8 py-4 border-2 border-emerald-600 text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-xl font-semibold text-lg transition-all duration-200 hover:scale-105'>
